...
function tdtd(dutyno, dutyaddr, dutyeryn, dutyname, dutytel1, wgs84lat, wgs84lon, dutytime1s, dutytime1c, dutytime2s, dutytime2c, dutytime3s, dutytime3c, dutytime4s, dutytime4c, dutytime5s, dutytime5c, dutytime6s, dutytime6c, dutytime7s, dutytime7c, dutytime8s, dutytime8c){
	// alert(dutyno);
	// alert(dutyname);
	// alert(wgs84lat);
	$("#detailInfoTbl").empty();
	var button = $("<button></button>").append("X").attr("onclick","empty()");
	var tdb = $("<td></td>").append(button).attr("id", "buttonTd");
    var td1 = $("<td></td>").append(dutyname);
	...
	var b6 = $("<br>");
	var b7 = $("<br>");
	var td5 = $("<td></td>").append("월요일", " ", dutytime1s, "~", dutytime1c, b1, "화요일", " ", dutytime2s, "~", dutytime2c, b2, "수요일", " ", dutytime3s, "~", dutytime3c, b3, "목요일", " ", dutytime4s, "~", dutytime4c, b4, "금요일", " ", dutytime5s, "~", dutytime5c, b5, "토요일", " ", dutytime6s, "~", dutytime6c, b6, "일요일", " ", dutytime7s, "~", dutytime7c, b7, "공휴일", " ", dutytime8s, "~", dutytime8c).attr("colspan", "2");
...
//		var nn = wr.hospitalInfo.dutyno;
//		alert(nn);
//		var t = wr.hospitalInfo.dutyname;
//		var t2 = wr.hospitalInfo.dutytel1;
//		var addr = wr.hospitalInfo.dutyaddr;
//		var eryn = wr.hospitalInfo.dutyeryn;
//		alert(eryn);
//		var s1 = wr.hospitalInfo.dutytime1s * 1;
//		var c1 = wr.hospitalInfo.dutytime1c * 1;
//		var s2 = wr.hospitalInfo.dutytime2s * 1;
//		var c2 = wr.hospitalInfo.dutytime2c * 1;
//		var s3 = wr.hospitalInfo.dutytime3s * 1;
//		var c3 = wr.hospitalInfo.dutytime3c * 1;
//		var s4 = wr.hospitalInfo.dutytime4s * 1;
//		var c4 = wr.hospitalInfo.dutytime4c * 1;
//		var s5 = wr.hospitalInfo.dutytime5s * 1;
//		var c5 = wr.hospitalInfo.dutytime5c * 1;
//		var s6 = wr.hospitalInfo.dutytime6s * 1;
//		var c6 = wr.hospitalInfo.dutytime6c * 1;
//		var s7 = wr.hospitalInfo.dutytime7s * 1;
//		var c7 = wr.hospitalInfo.dutytime7c * 1;
//		var s8 = wr.hospitalInfo.dutytime8s * 1;
//		var c8 = wr.hospitalInfo.dutytime8c * 1;
//		var lon2 = wr.hospitalInfo.wgs84lon * 1;
//		var lat2 = wr.hospitalInfo.wgs84lat * 1;
//		var td1 = $("<td></td>").append(t);
//		var td2 = $("<td></td>").append(addr);
//		var td3 = $("<td></td>").append(t2);
//		var td4 = $("<td></td>").append(eryn);
//		var td5 = $("<td></td>").append(s1);
...
function getList() { 
   ...
   $.getJSON("hospital.get.json?location=" + loc + "&yoil=" + yoil + "&hour=" + hour + "&minute=" + minute + "&dutyeryn=" + dutyeryn + "&searchInput=" + searchInput, function(we){
      ...
      $.each(we.hospitalInfo, function(i, h) {
         ...
         var td1 = $("<td></td>").append(t, b, t2).attr("onclick","tdtd(" + dn + ", '" + addr + "', " + eryn + ", '" + t + "','" + t2 + "'," + lat2 + "," + lon2 + "," + s1 + ","+ c1 + "," + s2 + ","+ c2 + "," + s3 + ","+ c3 + "," + s4 + ","+ c4 + "," + s5 + ","+ c5 + "," + s6 + ","+ c6 + "," + s7 + ","+ c7 + "," + s8 + ","+ c8 +")");
